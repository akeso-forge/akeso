...
class AkesoScanner:
    ...
    def _extract_cross_resource_metadata(self, shard: Shard, key: str, val: str) -> None:
        ...
        Args:
            ...
            val: The value
        """
        from akeso.parsers.metadata_extractors import get_extractors
